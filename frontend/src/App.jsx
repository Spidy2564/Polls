    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-white text-dark">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <div
          ...
          className={`w-72 border rounded-xl p-5 cursor-pointer transition-all ${selectedRole === "student"
        ...
        <div
          ...
          className={`w-72 border rounded-xl p-5 cursor-pointer transition-all ${selectedRole === "teacher"
            ? "border-primary shadow-md"
            : "border-muted bg-white"
            }`}
        >
      ...
      <button
        ...
        className="bg-primary hover:bg-secondary text-white px-8 py-3 rounded-full text-base font-semibold transition-all"
      >
        Continue
      </button>
    </div>
